...
ZYVA uses the selected free manual Greek-description workflow. Do not add a Google Translation key or billing-backed translation service. See `SETUP-BILINGUAL.md`.
...
14. Anonymous event APIs do not expose organizer contacts, user/reviewer IDs, internal costs, rejection notes or operational timestamps.
15. New-venue Instagram, Facebook, website and public booking-phone actions work after admin approval.
